...
<!--         <ul id="sidebar_menu" class="sidebar-nav  nav-pills nav-stacked"> -->
...
<%-- 					<li><a href="${pageContext.request.contextPath}/oferta/listarOfertas.html">Ofertas</a></li> --%>
...
<!-- 					</ul> -->
<%-- 					<li><a href="${pageContext.request.contextPath}/peticion/listarPeticiones.html">Peticiones</a></li> --%>
<!-- 					<ul class="nav navbar-nav  nav-pills nav-stacked"> -->
...
<%-- 			<c:if test='${usuario != null}'> --%>
<!--         <ul id="sidebar_menu" class="sidebar-nav  nav-pills nav-stacked"> -->
<%-- 				<li><a style="color:blue">Bienvenido/a ${usuario.nombre}</a> --%>
<%-- 				<a href="${pageContext.request.contextPath}/logout.html">Cerrar sesión</a></li> --%>
<!-- 			</ul> -->
<%-- 			</c:if> --%>
<!--       </div> -->
