	...
	<form:form method="post" modelAttribute="peticion">
		<table>
			<tr>
	            ...
	            <td><form:input path="fechaIni" id="fechaIni" placeholder="Fecha Inicio dd-mm-yyyy" /></td>
			</tr>
			<tr>
				<td><form:label path="fechaFin">Fecha Fin</form:label></td>
	            <td><form:input path="fechaFin" id="fechaFin" placeholder="Fecha Fin dd-mm-yyyy" /></td>
			</tr>
			<tr>
