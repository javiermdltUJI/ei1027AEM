...
<body>
	...
	<p>Las fechas de la peticion deben ajustarse a la colaboracion, por lo que la fecha de inicio debe ser menor o igual que <strong>${colaboracion.fechaIniString}</strong> y  la fecha de fin mayor o igual que <strong>${colaboracion.fechaFinString}</strong>.</p>
